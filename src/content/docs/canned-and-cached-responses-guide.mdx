export const metadata = {
  title: "Pre-configured and Cached Responses Guide",
  description:
    "Learn how to use pre-configured responses and response caching to optimize your chatbot's performance and reduce costs.",
  tags: [
    "canned-responses",
    "caching",
    "performance",
...
2. Scroll to **"Pre-configured Responses (Pre-configured)"** section
...
3. Is evaluation expired? (blocks LLM)
